...
#set up parameters
evol_params = {
    'num_processes' : 120, # (optional) number of processes for multiprocessing.Pool
...
while num_gen < max_num_gens:
    ...
    if (num_gen % 10 == 9):
      np.save('3s_Conceptual1_best_fit.npy',best_fit)
      np.save('3s_Conceptual1_mean_fit.npy',mean_fit)
      np.save('3s_Conceptual1_individual_genotype.npy',es.get_best_individual())
      np.save('3s_Conceptual1_individual_fitness.npy',es.get_best_individual_fitness())
